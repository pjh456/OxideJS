...
pub fn bind_string(core: &Arc<KernelCore>, session: &KernelSession, global: &mut JsObject) {
    let string_methods = StringMethods {
        ...
        anchor: oxide_builtins::string::string_anchor::<crate::vm::Vm> as *const (),
        big: oxide_builtins::string::string_big::<crate::vm::Vm> as *const (),
        blink: oxide_builtins::string::string_blink::<crate::vm::Vm> as *const (),
        bold: oxide_builtins::string::string_bold::<crate::vm::Vm> as *const (),
        fixed: oxide_builtins::string::string_fixed::<crate::vm::Vm> as *const (),
        fontcolor: oxide_builtins::string::string_fontcolor::<crate::vm::Vm> as *const (),
        fontsize: oxide_builtins::string::string_fontsize::<crate::vm::Vm> as *const (),
        italics: oxide_builtins::string::string_italics::<crate::vm::Vm> as *const (),
        link: oxide_builtins::string::string_link::<crate::vm::Vm> as *const (),
        small: oxide_builtins::string::string_small::<crate::vm::Vm> as *const (),
        strike: oxide_builtins::string::string_strike::<crate::vm::Vm> as *const (),
        sub: oxide_builtins::string::string_sub::<crate::vm::Vm> as *const (),
        sup: oxide_builtins::string::string_sup::<crate::vm::Vm> as *const (),
    };
