...
use super::aggregate::{
    promise_static_all, promise_static_all_keyed, promise_static_all_settled, promise_static_all_settled_keyed,
    promise_static_any, promise_static_race, promise_static_reject, promise_static_resolve, promise_static_try,
...
impl Vm {
    ...
    pub(crate) fn init_promise_intrinsics(&mut self) {
        ...
        oxide_kernel::bind_methods_static!(
            ...
            ("allSettledKeyed", promise_static_all_settled_keyed as *const (), 1),
